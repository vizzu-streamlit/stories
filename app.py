...
st.markdown('''
            **Create and publish similar data stories in ![Streamlit](https://streamlit.io/images/brand/streamlit-mark-color.svg) Streamlit with [ipyvizzu-story](https://github.com/vizzuhq/ipyvizzu-story)**
