...
st.markdown('''
            **Create and publish similar data stories in <img src="https://streamlit.io/images/brand/streamlit-mark-color.svg" alt="logo" height="20"/>  Streamlit with [ipyvizzu-story](https://github.com/vizzuhq/ipyvizzu-story)**
