...
st.markdown('''
            **Create and publish similar data stories in ![Streamlit](Resources/streamlit-mark-color.png) Streamlit with [ipyvizzu-story](https://github.com/vizzuhq/ipyvizzu-story)**
